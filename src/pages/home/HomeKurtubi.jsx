    ...
    <div>
        ...
        <div style={{background: "rgba(7, 7, 7, 0.7)"}} className=" p-3 py-16 lg:py-36 sm:p-10 lg:px-40 text-white">
            <div className="lg:flex lg:space-x-16 lg:items-center  md:justify-center">
                <div data-aos="fade-right" className="relative md:w-full md:h-full md:object-cover">
                ...
                <div data-aos="fade-left" className="md:w-full md:h-full">
            ...
            <div   className=" text-center lg:flex lg:justify-evenly">
                <div data-aos="fade-right" className="m-14">
                ...
                <div data-aos="fade-up" className="m-14">
                    <p className="font-bold text-5xl py-4">
                        <animated.div >
                            {number.to((value)=> value.toFixed())}
                        </animated.div>
                ...
                <div data-aos="fade-left" className="m-14">
                    <p className="font-bold text-5xl py-4">
                        <animated.div >
                            {number.to((value)=> value.toFixed())}
                        </animated.div>
