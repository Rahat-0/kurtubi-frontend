  ...
  return (
    <div className="bg-gray-900 text-sm">
      <div className=" text-white grid md:grid-cols-2 xl:grid-cols-4 md:p-20 md:place-items-center md:items-start ">
        <div className="">
          <h5 className="text-2xl font-bold py-7 px-4">Get in Touch</h5>
        ...
        <div className="">
          <h5 className="text-2xl font-bold py-7 px-4">Branding</h5>
        ...
        <div className="">
          <h5 className="text-2xl font-bold py-7 px-4">Useful Links</h5>
          <ul className="list-disc px-10 leading-8 text-gray-300">
            <li>
              <a className="text-gray-300 hover:text-white" href="##">
                Campus Contact
        ...
        <div className="">
          <h5 className="text-2xl font-bold py-7 px-4">Subscribe Us!</h5>
          ...
          <h6 className="text-2xl font-bold py-7 px-4">Connect With Us</h6>
      ...
      ></div>
      <p className="text-center pb-28 p-4 text-white">
